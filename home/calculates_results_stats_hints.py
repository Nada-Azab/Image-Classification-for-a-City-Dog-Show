...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_match'] =((len(results_stats_dic['n_match'])/len(results_stats_dic['n_images']))*100)
    ...
    results_stats_dic['pct_correct_dogs'] =((len(results_stats_dic['n_correct_dogs'])/len(results_stats_dic['n_dogs_img']))*100)
    ...
    results_stats_dic['pct_correct_breed'] =((len(results_stats_dic['n_correct_breed'])/len(results_stats_dic['n_dogs_img']))*100)
